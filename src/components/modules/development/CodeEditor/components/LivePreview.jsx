...
import {
  RefreshCw, Smartphone, Tablet, Monitor, Eye
} from 'lucide-react';
...
<body>
  ...
  }, [previewUrl, generatePreviewHTML]);
  ...
  }, [currentFile?.content, currentFile?.language, refreshPreview]);

  useEffect(() => {
    // Revocar la URL de vista previa cuando el componente se desmonta
    return () => {
      if (previewUrl) {
