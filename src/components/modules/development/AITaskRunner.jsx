        ...
        <div className="bg-[#0d1117] border border-white/10 rounded-2xl p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-[#13ecc8]/10 rounded-xl flex items-center justify-center">
              <Sparkles className="text-[#13ecc8]" size={24} />
            </div>
            <div>
              <h2 className="text-xl font-bold">AI Task Runner</h2>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">
              Próximamente podrás ejecutar tareas automatizadas con IA desde aquí.
            </p>
          </div>
        </div>
      </div>
